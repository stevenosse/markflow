class Dimens {
  ...
  static const double editorTabWidth = 200.0;
  static const double editorSidebarWidth = 280.0;
  static const double editorToolbarHeight = 48.0;

  // File Tree
  static const double fileTreeWidth = 280.0;
  static const double fileTreeIndent = 20.0;
  static const double fileTreeItemHeight = 40.0;
  static const double fileTreeIconSize = 16.0;

  // Git Panel
  static const double gitPanelWidth = 320.0;
  static const double gitCommitItemHeight = 80.0;
  ...
  static const double fabSizeS = 40.0;
  static const double fabSizeL = 64.0;

  // Loading
  static const double loaderSize = 25.0;
  static const double loaderSizeS = 20.0;
  static const double loaderSizeL = 32.0;
